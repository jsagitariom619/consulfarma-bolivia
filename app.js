...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const oilCatalog = [
    { slug: 'aceite-coco-extra-virgen', name: 'Aceite de Coco Extra Virgen', category: 'Aceites Naturales', audience: 'Cuidado de piel y cabello', summary: 'Aceite de coco artesanal, prensado en frío y sin químicos ni aditivos según su etiqueta.', purpose: 'Puede incorporarse a rutinas cosméticas para acondicionar el cabello, suavizar zonas secas de la piel o complementar un masaje corporal.', description: 'Aceite de coco extra virgen artesanal y orgánico. Su etiqueta lo identifica como un producto 100% natural, prensado en frío y orientado al cuidado corporal, capilar y de la piel.', benefits: ['Ayuda a mantener acondicionados el cabello y la piel.', 'Favorece una sensación de suavidad en zonas secas.', 'Puede utilizarse como complemento de un masaje corporal.', 'Prensado en frío y sin químicos ni aditivos según la etiqueta.'], presentation: 'Frasco de 200 ml', imageAlt: 'Frasco de Aceite de Coco Extra Virgen de 200 ml', inquiry: 'del Aceite de Coco Extra Virgen' },
    { slug: 'aceite-oregano-extra-virgen', name: 'Aceite de Orégano Extra Virgen', category: 'Aceites Naturales', audience: 'Producto artesanal', summary: 'Aceite natural artesanal elaborado a base de orégano, en presentación con gotero.', purpose: 'Permite disponer de aceite de orégano en una presentación práctica. Su vía, dilución y forma de uso deben seguir exclusivamente las indicaciones del fabricante.', description: 'Aceite de orégano extra virgen identificado en su etiqueta como 100% natural, artesanal y sin aditivos. No se recomienda una vía de uso porque la fotografía no permite verificar concentración, dilución ni instrucciones completas.', benefits: ['Elaborado a base de orégano.', 'Presentación práctica con gotero.', 'Identificado como extra virgen en su etiqueta.', 'Declarado sin aditivos por el fabricante.'], presentation: 'Frasco con gotero de 30 ml', imageAlt: 'Frasco de Aceite de Orégano Extra Virgen de 30 ml', inquiry: 'del Aceite de Orégano Extra Virgen de 30 ml' },
    { slug: 'aceite-ricino', name: 'Aceite de Ricino', category: 'Aceites Naturales', audience: 'Presentaciones de 30 ml y 60 ml', summary: 'Aceite vegetal para complementar rutinas cosméticas de cabello, piel, cejas y pestañas.', purpose: 'Puede incorporarse a rutinas de cuidado y acondicionamiento del cabello, cejas y pestañas, además de ayudar a suavizar zonas secas de la piel.', description: 'Aceite vegetal de ricino utilizado tradicionalmente en el cuidado cosmético por sus cualidades emolientes y acondicionadoras. Se ofrece en dos tamaños para adaptarse a distintas rutinas.', benefits: ['Ayuda a acondicionar el cabello.', 'Contribuye a mantener la hidratación de zonas secas.', 'Puede utilizarse en rutinas cosméticas para cejas y pestañas.', 'Favorece una sensación de suavidad en la piel.'], presentation: 'Frascos de 30 ml y 60 ml', imageAlt: 'Frasco de Aceite de Ricino de 60 ml', inquiry: 'del Aceite de Ricino de 30 ml o 60 ml' }
  ];
  const soapCatalog = [
