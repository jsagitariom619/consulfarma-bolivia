...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const oilCatalog = [
    { slug: 'aceite-coco-extra-virgen', name: 'Aceite de Coco Extra Virgen', category: 'Aceites Naturales', audience: 'Cuidado de piel y cabello', summary: 'Aceite natural de textura emoliente para complementar el cuidado cosmético de la piel y el cabello.', purpose: 'Puede utilizarse como complemento cosmético para hidratar, suavizar y acondicionar la piel y el cabello, especialmente cuando presentan sensación de sequedad.', description: 'Aceite de coco extra virgen de origen natural, utilizado tradicionalmente en rutinas de cuidado personal por sus propiedades emolientes y acondicionadoras. Su textura permite incorporarlo al cuidado de la piel y el cabello.', benefits: ['Ayuda a mantener la hidratación de la piel.', 'Contribuye a suavizar zonas secas.', 'Proporciona una sensación de piel más suave y acondicionada.', 'Ayuda a reducir la sensación de resequedad.', 'Puede utilizarse como aceite corporal.', 'Puede incorporarse a rutinas de masaje corporal.', 'Ayuda a acondicionar el cabello.', 'Contribuye a mejorar la suavidad del cabello.', 'Puede ayudar a disminuir la apariencia de cabello seco o áspero.', 'Aporta brillo cosmético al cabello.', 'Puede utilizarse como complemento del cuidado de puntas secas.', 'Es útil dentro de rutinas de cuidado de piel y cabello.'], presentation: 'Frasco de 200 ml', imageAlt: 'Frasco de Aceite de Coco Extra Virgen de 200 ml', inquiry: 'del Aceite de Coco Extra Virgen' },
    { slug: 'aceite-oregano-extra-virgen', name: 'Aceite de Orégano Extra Virgen', category: 'Aceites Naturales', audience: 'Producto artesanal', summary: 'Aceite natural artesanal elaborado a base de orégano, en presentación con gotero.', purpose: 'Permite disponer de aceite de orégano en una presentación práctica. Su vía, dilución y forma de uso deben seguir exclusivamente las indicaciones del fabricante.', description: 'Aceite de orégano extra virgen identificado en su etiqueta como 100% natural, artesanal y sin aditivos. No se recomienda una vía de uso porque la fotografía no permite verificar concentración, dilución ni instrucciones completas.', benefits: ['Elaborado a base de orégano.', 'Forma parte de la línea de productos naturales artesanales.', 'Presentación práctica en frasco con gotero.', 'El gotero facilita la dosificación física del producto cuando se utiliza conforme a las indicaciones correspondientes.', 'Identificado como extra virgen y sin aditivos en su etiqueta.'], presentation: 'Frasco con gotero de 30 ml', imageAlt: 'Frasco de Aceite de Orégano Extra Virgen de 30 ml', inquiry: 'del Aceite de Orégano Extra Virgen' },
    { slug: 'aceite-ricino', name: 'Aceite de Ricino — 60 ml', category: 'Aceites Naturales', audience: 'Cuidado cosmético', summary: 'Aceite vegetal emoliente para complementar rutinas de cuidado del cabello, piel, cejas y pestañas.', purpose: 'Se utiliza principalmente como complemento de rutinas cosméticas destinadas a acondicionar, suavizar y mantener hidratados el cabello y determinadas zonas de la piel. También puede incorporarse al cuidado cosmético de cejas y pestañas.', description: 'Aceite vegetal utilizado tradicionalmente dentro de las rutinas de cuidado cosmético por sus propiedades emolientes y acondicionadoras. Puede incorporarse al cuidado del cabello, piel, cejas y pestañas.', benefits: ['Ayuda a acondicionar el cabello.', 'Contribuye a mantener la hidratación del cabello.', 'Ayuda a mejorar la sensación de suavidad.', 'Puede proporcionar brillo cosmético.', 'Complementa el cuidado de cabello seco.', 'Puede utilizarse en las puntas del cabello.', 'Ayuda a mantener acondicionadas las cejas.', 'Puede incorporarse al cuidado cosmético de las pestañas.', 'Ayuda a mantener cejas y pestañas acondicionadas.', 'Puede utilizarse en zonas secas de la piel.', 'Contribuye a suavizar la piel.', 'Posee propiedades emolientes.', 'Puede complementar rutinas de masaje y cuidado personal.'], presentation: 'Frasco de 60 ml', imageAlt: 'Frasco de Aceite de Ricino de 60 ml', inquiry: 'del Aceite de Ricino de 60 ml' }
  ];
  const soapCatalog = [
    { slug: 'jabon-arroz-arcilla', name: 'Jabón de Arroz y Arcilla', category: 'Jabones Artesanales', audience: 'Cuidado cosmético suave', summary: 'Jabón artesanal de arroz y arcilla para una limpieza delicada y confortable.', purpose: 'Puede incorporarse a la limpieza cotidiana para retirar impurezas superficiales y complementar el cuidado de la apariencia de la piel.', description: 'Jabón artesanal elaborado con arroz y arcilla. Su propuesta cosmética combina limpieza suave, hidratación y una sensación calmante para el cuidado habitual.', benefits: ['Ayuda a limpiar suavemente la piel.', 'Contribuye a mantener una sensación de hidratación.', 'Favorece una apariencia más uniforme y cuidada.', 'Puede proporcionar una sensación calmante y confortable.'], presentation: 'Unidad artesanal', imageAlt: 'Jabón artesanal de Arroz y Arcilla', inquiry: 'del Jabón de Arroz y Arcilla' },
    { slug: 'jabon-carbon-activado', name: 'Jabón de Carbón Activado', category: 'Jabones Artesanales', audience: 'Limpieza profunda', summary: 'Jabón artesanal con carbón activado para complementar la limpieza de pieles con tendencia grasa.', purpose: 'Ayuda a retirar grasa e impurezas de la superficie de la piel y a mejorar visualmente la apariencia de poros y puntos negros.', description: 'Jabón artesanal de carbón activado orientado a una limpieza cosmética profunda. Puede ser una opción para complementar el cuidado de pieles con tendencia grasa o brillo visible.', benefits: ['Ayuda a retirar impurezas superficiales.', 'Contribuye a absorber el exceso de grasa.', 'Favorece una sensación de limpieza profunda.', 'Complementa el cuidado cosmético de poros y puntos negros.'], presentation: 'Unidad artesanal', imageAlt: 'Jabón artesanal de Carbón Activado', inquiry: 'del Jabón de Carbón Activado' },
    { slug: 'jabon-cafe-canela', name: 'Jabón de Café y Canela', category: 'Jabones Artesanales', audience: 'Exfoliación corporal', summary: 'Jabón artesanal de café y canela con efecto exfoliante para el cuidado corporal.', purpose: 'Puede utilizarse durante la limpieza corporal para realizar una exfoliación cosmética y acompañar el masaje de la piel.', description: 'Jabón artesanal de café y canela pensado para complementar rutinas de exfoliación y masaje corporal, ayudando a mantener una piel de apariencia suave y cuidada.', benefits: ['Ayuda a retirar células superficiales mediante la exfoliación.', 'Favorece una apariencia más suave y uniforme.', 'Complementa el masaje durante el cuidado corporal.', 'Contribuye a una sensación de piel renovada.'], presentation: 'Unidad artesanal', imageAlt: 'Jabón artesanal de Café y Canela', inquiry: 'del Jabón de Café y Canela' },
    { slug: 'jabon-avena-miel', name: 'Jabón de Avena y Miel', category: 'Jabones Artesanales', audience: 'Limpieza e hidratación', summary: 'Jabón artesanal de avena y miel para una limpieza suave con sensación hidratante.', purpose: 'Puede incorporarse a la higiene habitual para limpiar delicadamente y aportar una sensación de suavidad y confort.', description: 'Jabón artesanal elaborado con avena y miel, orientado a una limpieza cosmética suave y al cuidado cotidiano de la piel.', benefits: ['Ayuda a limpiar suavemente la piel.', 'Contribuye a mantener una sensación de hidratación.', 'Favorece la suavidad de la piel.', 'Puede proporcionar una sensación calmante y confortable.'], presentation: 'Unidad artesanal', imageAlt: 'Jabón artesanal de Avena y Miel', inquiry: 'del Jabón de Avena y Miel' },
    { slug: 'jabon-hidratante', name: 'Jabón Hidratante', category: 'Jabones Artesanales', audience: 'Cuidado diario', summary: 'Jabón artesanal pensado para limpiar y complementar una rutina de hidratación cotidiana.', purpose: 'Sirve para la higiene habitual y ayuda a conservar una sensación de suavidad y confort después de la limpieza.', description: 'Jabón artesanal hidratante y humectante, pensado para una limpieza cotidiana que favorezca una apariencia fresca y cuidada.', benefits: ['Ayuda a limpiar sin descuidar la sensación de hidratación.', 'Contribuye a mantener la piel suave.', 'Favorece una sensación refrescante.', 'Complementa rutinas de cuidado diario.'], presentation: 'Unidad artesanal', imageAlt: 'Jabón artesanal Hidratante', inquiry: 'del Jabón Hidratante' },
    { slug: 'jabon-arcilla-rosada', name: 'Jabón de Arcilla Rosada', category: 'Jabones Artesanales', audience: 'Limpieza delicada', summary: 'Jabón artesanal de arcilla rosada para una limpieza profunda con sensación de confort.', purpose: 'Puede complementar la limpieza habitual ayudando a retirar impurezas superficiales y dejando una sensación calmante.', description: 'Jabón artesanal de arcilla rosada orientado al cuidado cosmético y a una limpieza que procura mantener la piel confortable.', benefits: ['Ayuda a retirar impurezas superficiales.', 'Favorece una sensación de limpieza profunda.', 'Puede proporcionar una sensación calmante.', 'Contribuye a una apariencia fresca y cuidada.'], presentation: 'Unidad artesanal', imageAlt: 'Jabón artesanal de Arcilla Rosada', inquiry: 'del Jabón de Arcilla Rosada' },
    { slug: 'jabon-arcilla-verde', name: 'Jabón de Arcilla Verde', category: 'Jabones Artesanales', audience: 'Piel con tendencia grasa', summary: 'Jabón artesanal de arcilla verde para complementar la limpieza de pieles con tendencia grasa.', purpose: 'Ayuda a retirar el exceso de grasa y las impurezas superficiales, contribuyendo a disminuir temporalmente la apariencia de brillo.', description: 'Jabón artesanal de arcilla verde con superficie de masaje, orientado a la limpieza cosmética de pieles con tendencia grasa.', benefits: ['Ayuda a absorber el exceso de grasa superficial.', 'Favorece la limpieza cosmética de los poros.', 'Puede disminuir temporalmente la apariencia de brillo.', 'Complementa el cuidado de pieles con tendencia grasa.'], presentation: 'Unidad artesanal con superficie de masaje', imageAlt: 'Jabón artesanal de Arcilla Verde con superficie de masaje', inquiry: 'del Jabón de Arcilla Verde' }
  ];
  const alumCatalog = [
    { slug: 'piedra-alumbre-60g', name: 'Piedra de Alumbre — 60 g', category: 'Cuidado Personal Natural', audience: 'Desodorante natural', summary: 'Piedra de alumbre en formato compacto para complementar la higiene personal cotidiana.', purpose: 'Puede utilizarse como desodorante mineral para ayudar a neutralizar el olor corporal dentro de la rutina de higiene diaria.', description: 'Piedra de alumbre presentada en un práctico envase de 60 g. La etiqueta la identifica como desodorante 100% natural, sin químicos ni aditivos y apto para pieles sensibles.', benefits: ['Ayuda a neutralizar el olor corporal.', 'Formato compacto y práctico.', 'Sin químicos ni aditivos según la etiqueta.', 'Indicada en la etiqueta como apta para pieles sensibles.'], presentation: 'Envase de 60 g', imageAlt: 'Piedra de Alumbre de 60 gramos', inquiry: 'de la Piedra de Alumbre de 60 g' },
    { slug: 'piedra-alumbre-120g', name: 'Piedra de Alumbre — 120 g', category: 'Cuidado Personal Natural', audience: 'Desodorante natural', summary: 'Piedra de alumbre en presentación amplia para complementar la higiene personal cotidiana.', purpose: 'Puede utilizarse como desodorante mineral para ayudar a neutralizar el olor corporal dentro de la rutina de higiene diaria.', description: 'Piedra de alumbre presentada en un envase de 120 g. La etiqueta la identifica como desodorante 100% natural, sin químicos ni aditivos y apto para pieles sensibles.', benefits: ['Ayuda a neutralizar el olor corporal.', 'Presentación amplia de 120 g.', 'Sin químicos ni aditivos según la etiqueta.', 'Indicada en la etiqueta como apta para pieles sensibles.'], presentation: 'Envase de 120 g', imageAlt: 'Piedra de Alumbre de 120 gramos', inquiry: 'de la Piedra de Alumbre de 120 g' }
  ];
  ...
  soapCatalog.forEach((product) => Object.assign(product, { imageWidth: 600, imageHeight: 600 }));
  ...
  if (productTracks.length && productDialog) {
    ...
    const renderProducts = (productTrack, products) => products.forEach((product) => {
      ...
      const availabilityMessage = product.inquiry ? `Hola, quisiera consultar la disponibilidad ${product.inquiry}.` : `Hola, quisiera consultar la disponibilidad de ${product.name}`;
      card.innerHTML = `<button class="product-image-button" type="button" aria-label="Ver ${product.name}"><img src="assets/productos/thumbs/${product.slug}.webp" alt="${product.imageAlt}" width="${product.imageWidth || 520}" height="${product.imageHeight || 780}" loading="lazy"></button><div class="product-card-body"><span class="product-category">${product.category}</span><h3>${product.name}</h3><span class="product-audience">${product.audience}</span><p>${product.summary}</p><strong class="product-purpose-label">¿Para qué sirve?</strong><p class="product-purpose-summary">${product.purpose}</p><ul><li>${product.benefits[0]}</li><li>${product.benefits[1]}</li></ul><div class="product-presentation">${product.presentation}</div><div class="product-actions"><button class="btn product-view" type="button">Ver detalles</button><a class="product-whatsapp" href="https://wa.me/59175919302?text=${encodeURIComponent(availabilityMessage)}" target="_blank" rel="noopener">Consultar disponibilidad</a></div></div>`;
      const openProduct = (trigger) => {
        ...
        dialogWhatsApp.href = `https://wa.me/59175919302?text=${encodeURIComponent(availabilityMessage)}`;
    ...
    if (productTracks[2]) renderProducts(productTracks[2], oilCatalog);
    if (productTracks[3]) renderProducts(productTracks[3], soapCatalog);
    if (productTracks[4]) renderProducts(productTracks[4], alumCatalog);
